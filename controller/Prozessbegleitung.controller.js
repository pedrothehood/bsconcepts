...
sap.ui.define([
	...
	return BaseController.extend("ypglmasterdetailportal.controller.Prozessbegleitung", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("prozessbegleitung").attachPatternMatched(this._onObjectMatched, this);
