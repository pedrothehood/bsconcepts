...
sap.ui.define([
	...
	return BaseController.extend("ypglmasterdetailportal.controller.FengShui", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("fengShui").attachPatternMatched(this._onObjectMatched, this);
