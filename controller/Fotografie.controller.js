...
sap.ui.define([
	...
	return BaseController.extend("ypglmasterdetailportal.controller.Fotografie", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("fotografie").attachPatternMatched(this._onObjectMatched, this);
